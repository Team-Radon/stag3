  ...
  <Card className="group border-2 border-transparent hover:border-indigo-300 transition-all">
    <Link href={project.stream_id} title={project.content?.title} className="flex justify-between">
      <div>
        ...
        <Button size="sm" className="flex items-center border-none hover:bg-indigo-100/50">
      ...
      <div className="flex flex-col justify-between shrink-0 ml-4">
        ...
        <Link href="#" className="flex justify-center px-2 py-1 rounded-md hover:bg-indigo-100/50">
